...
list.edge.attributes(YX_1981_net1)
...
# use this to see if the edge attribute is set.
...
#' 
## ----figs2, echo = FALSE, warning=FALSE, message=FALSE, fig.pos="H", fig.align='center', fig.cap="\\label{fig:figs2} Figure 2: Trade Network for 1981", fig.height=7, fig.width=8----
...
#' 
#' Second assortativity measure is "**assortativity**". This calculates assortavity based on values assigned to the vertices. It is defined as: 
#' 
...
#' 
## ------------------------------------------------------------------------
assortativity(YX_1981_net1_igraph, types1= V(YX_1981_net1_igraph)$lgdp.exp, directed = TRUE) # assortativity coefficient based on log GDP
assortativity(YX_1981_net1_igraph, types1= V(YX_1981_net1_igraph)$pty.exp, directed = TRUE) # assortativity coefficient based on polity score
...
#' 
#' A third measure "**assortativity_degree**" calculates the degree assortativity of the network This uses vertex degree (minus one) as vertex values and calls assortativity. The assortativity degree of the network is -.2. Random network have assortatitivy degree of close to 0.
#' 
## ------------------------------------------------------------------------
...
#' 
#' I found **"assortment.discrete()"** useful as it provides a mixing matrix which show the distribution of edges or edge weights by categories. 
#' 
## ---- warning=FALSE, message=FALSE---------------------------------------
...
Assortativity_network <- numeric(20)
...
Assortativity_network[i] <- assortativity_degree(YX_year_net_igraph, directed = TRUE) # the degree assortativity of the network
...
assortativity_df <- as.data.frame(cbind(Assortativity_year, Assortativity_lgdp,Assortativity_polity,
                                        Assortativity_network, assortment.lgdp, assortment.pty,
...
#' 
## ----figs3, echo = FALSE, fig.pos="H", fig.align='center', fig.cap="\\label{fig:figs3} Figure 3: Assortativity coefficients 1981-2001 ", fig.height=5, fig.width=8----
ggplot(assortativity_df) + 
                    ...
                    geom_line(data=assortativity_df, aes(x=Assortativity_year, y=Assortativity_network,
                                                         color="Assortativity_network")) + 
                    ...
                    labs(x="Time (By Year)",y="Assortativity coefficient") + 
                     scale_colour_manual(name='Legend', 
                                         values=c('Assortativity_lgdp'='green4', 'Assortativity_polity'='dodgerblue4',
                                                  'Assortativity_network'='black', 'assortment.lgdp'='red4',
...
#' 
#' **Figure 4** illustrate the assortativity coefficients based on numrical and categorical polity attributes. Both types of polity attributes (numerical and categorical) seem to be highly correlated. 
#' 
## ----figs4, echo = FALSE, fig.pos="H", fig.align='center', fig.cap="\\label{fig:figs4} Figure 4: Assortativity coefficients based on polity (numerical and categorical) 1981-2001 ", fig.height=5, fig.width=8----
ggplot(assortativity_df) + 
                    geom_line(data=assortativity_df, aes(x=Assortativity_year, y=Assortativity_polity,
                                                         color="Assortativity_polity")) + 
                    geom_line(data=assortativity_df, aes(x=Assortativity_year, y=assortment.pty, 
...
#' 
#' It is interesting to see the distribution of edge weights (% of total weight) between each polity group. We can use the mixing matrix that is returned from using **"assortment.discrete"** function from **'assortnet'** to visualize the edge weights by categories. I only present democracy to democracy and autocracy to autocracy relationships in **Figure 5**.
#' 
## ----figs5, echo = FALSE, fig.pos="H", fig.align='center', fig.cap="\\label{fig:figs5} Figure 5: Distribution of edge weights (% of total weight) based on similar polity category (for democracies and autocracies 1981-2001)", fig.height=5, fig.width=8----
ggplot(assortativity_df) + 
